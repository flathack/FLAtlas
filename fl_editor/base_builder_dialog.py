...
class BaseBuilderDialog(QDialog):
    def __init__(
        ...
        *,
        ...
        control_row.addLayout(move_row, 1)

        rotate_row = QHBoxLayout()
        rotate_row.addWidget(QLabel("Rotate", transform_box))
        ...
        control_row.addLayout(rotate_row, 1)
        control_row.addStretch(1)
        transform_layout.addLayout(control_row)

        mode_row = QHBoxLayout()
        mode_row.addWidget(QLabel("Viewport", transform_box))
        self._mode_group = QButtonGroup(self)
        self._mode_group.setExclusive(True)
        self._mode_nav_btn = self._build_mode_button("Navigate", "navigate")
        self._mode_move_btn = self._build_mode_button("Move", "move")
        self._mode_rotate_btn = self._build_mode_button("Rotate", "rotate")
        ...
        axis_row.addWidget(QLabel("Drag Axis", transform_box))
        ...
        transform_layout.addLayout(axis_row)
        ...
        self._reset_camera_btn.setMinimumHeight(42)
        self._reset_camera_btn.clicked.connect(self._reset_camera)
        transform_layout.addWidget(self._reset_camera_btn)
