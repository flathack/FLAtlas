...
def build_ini_editor_page(window, *, tr, code_editor_factory, highlighter_factory, minimap_factory):
    ...
    window._ini_path_stack = QWidget()
    path_stack_layout = QVBoxLayout(window._ini_path_stack)
    path_stack_layout.setContentsMargins(0, 0, 0, 0)
    path_stack_layout.setSpacing(2)
    window._ini_path_breadcrumb_host = QWidget()
    window._ini_path_breadcrumb_layout = QHBoxLayout(window._ini_path_breadcrumb_host)
    window._ini_path_breadcrumb_layout.setContentsMargins(0, 0, 0, 0)
    window._ini_path_breadcrumb_layout.setSpacing(2)
    path_stack_layout.addWidget(window._ini_path_breadcrumb_host)
    window.ini_root_path_lbl = QLineEdit("-")
    window.ini_root_path_lbl.setReadOnly(True)
    path_stack_layout.addWidget(window.ini_root_path_lbl)
    tl.addWidget(window._ini_path_stack, 1)
    ...
    window._ini_fe_trash_btn = QPushButton(tr("ini.explorer.trash"))
    window._ini_fe_trash_btn.clicked.connect(window._ini_explorer_open_trash_dialog)
    fe_toolbar.addWidget(window._ini_fe_trash_btn)
    ...
    window._ini_fe_file_tree.itemSelectionChanged.connect(window._ini_explorer_on_selection_changed)
